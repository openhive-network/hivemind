1. Reference tables should be in schema "public_reference".
2. Testing tables should be in schema "public".
3. Functions are safeing in schema "public_reference".
4. Owner of functions is set as "hivemind_ci".
...
It is possible to run an automated test procedure for multiple functions using a scripts "table_test_save_to_db.sh" or "table_test_save_to_file.sh"
