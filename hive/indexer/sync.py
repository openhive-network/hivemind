...
class SyncHiveDb:
    ...
    def run(self) -> None:
        ...
        if not Blocks.is_consistency():
            ...
            # only fully processed block are committed, and broken live is always consistent
    ...
    def _query_for_app_irreversible_block(self) -> int:
        irreversible_block = self._db.query_row(f"SELECT * FROM hive.app_get_irreversible_block()")
