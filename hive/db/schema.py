...
def setup_runtime_code(db):
    sql_scripts = [
        ...
        "postgrest/utilities/moderation_log.sql",
        "postgrest/bridge_api/bridge_api_get_community_moderation_log.sql",
        "postgrest/bridge_api/bridge_api_get_account_moderation_stats.sql",
        "postgrest/bridge_api/bridge_api_get_moderator_activity.sql",
