...
def setup(db):
    ...
    sql = """
        ...
        DROP FUNCTION IF EXISTS list_votes_by_voter_comment_pre24( character varying, character varying, character varying, int )
        ;
        CREATE OR REPLACE FUNCTION public.list_votes_by_voter_comment_pre24
        (
        ...
        DROP FUNCTION IF EXISTS list_votes_by_comment_voter_pre24( character varying, character varying, character varying, int )
        ;
        CREATE OR REPLACE FUNCTION public.list_votes_by_comment_voter_pre24
        (
          in _VOTER hive_accounts.name%TYPE,
          in _AUTHOR hive_accounts.name%TYPE,
          in _PERMLINK hive_permlink_data.permlink%TYPE,
