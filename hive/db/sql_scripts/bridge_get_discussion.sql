...
BEGIN
    ...
    (
        ...
        (
            ...
            LEFT JOIN hive_roles ON hive_roles.community_id = children.category_id
 ...
 LATERAL get_post_view_by_id(ds.id) hpv
    LEFT JOIN hive_roles hr ON hr.community_id = hpv.category_id
    WHERE NOT hpv.is_muted OR NOT hr.role_id = -2
    ORDER BY ds.id
    LIMIT 2000;
END
