...
-- DROP FUNCTION public.bridge_get_by_feed_with_reblog(character varying, character varying, character varying, integer, boolean);
...
ALTER FUNCTION public.bridge_get_by_feed_with_reblog(character varying, character varying, character varying, integer, boolean)
    OWNER TO hive;
