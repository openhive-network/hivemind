...
-- REST API versions that return SETOF for PostgREST

DROP FUNCTION IF EXISTS hivemind_postgrest_utilities.get_reblogged_posts_for_all_rest;
CREATE FUNCTION hivemind_postgrest_utilities.get_reblogged_posts_for_all_rest(
  IN _post_id INT,
  IN _observer_id INT,
  IN _limit INT,
  IN _sort_type hivemind_postgrest_utilities.ranked_post_sort_type
...
DROP FUNCTION IF EXISTS hivemind_postgrest_utilities.get_reblogged_posts_for_observer_communities_rest;
CREATE FUNCTION hivemind_postgrest_utilities.get_reblogged_posts_for_observer_communities_rest(
  IN _post_id INT,
  IN _observer_id INT,
  IN _limit INT,
  IN _sort_type hivemind_postgrest_utilities.ranked_post_sort_type
...
DROP FUNCTION IF EXISTS hivemind_postgrest_utilities.get_reblogged_posts_for_community_rest;
CREATE FUNCTION hivemind_postgrest_utilities.get_reblogged_posts_for_community_rest(
  IN _post_id INT,
  IN _observer_id INT,
  IN _limit INT,
  IN _tag TEXT,
...
DROP FUNCTION IF EXISTS hivemind_postgrest_utilities.get_reblogged_posts_for_tag_rest;
CREATE FUNCTION hivemind_postgrest_utilities.get_reblogged_posts_for_tag_rest(
  IN _post_id INT,
  IN _observer_id INT,
  IN _limit INT,
  IN _tag TEXT,
