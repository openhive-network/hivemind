...
CREATE FUNCTION hivemind_postgrest_utilities.get_account_posts_by_blog(IN _account_id INT, IN _post_id INT, IN _observer_id INT, IN _limit INT, IN _called_from_bridge_api BOOLEAN)
...
BEGIN
  ...
  SELECT
      ...
      hp.is_hidden,
      -- is grayed - if author is muted by observer, make post gray
      hp.is_grayed OR _posts_should_be_grayed,
      hp.total_votes,
      hp.sc_trend,
      hp.role_title,
      hp.community_title,
