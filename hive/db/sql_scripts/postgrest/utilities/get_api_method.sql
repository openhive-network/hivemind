...
BEGIN
  CASE
    ...
    WHEN __method_type = 'get_followers' THEN
      result := hivemind_endpoints.condenser_api_get_followers(__json_with_params_is_object, __params, /* _called_from_condenser_api */ True);
    WHEN __method_type = 'get_following' THEN
      result := hivemind_endpoints.condenser_api_get_following(__json_with_params_is_object, __params, /* _called_from_condenser_api */ True);
...
BEGIN
  CASE
    ...
    WHEN __method_type = 'get_reblogged_by' THEN
      result := hivemind_endpoints.condenser_api_get_reblogged_by(__json_with_params_is_object, __params);
    WHEN __method_type = 'get_followers' THEN
      result := hivemind_endpoints.condenser_api_get_followers(__json_with_params_is_object, __params, /* _called_from_condenser_api */ False);
    WHEN __method_type = 'get_following' THEN
...
BEGIN
  CASE
    ...
    WHEN __method_type = 'get_post' THEN
      result := hivemind_endpoints.bridge_api_get_post(__json_with_params_is_object, __params);
    ...
    WHEN __method_type = 'normalize_post' THEN
      ...
      result := hivemind_endpoints.bridge_api_get_post(True, jsonb_build_object('author', __params->'post'->>'author', 'permlink', __params->'post'->>'permlink'));
