...
@return_error_info
@nested_query_compat
async def get_discussions(context, sort: str, start_author: str = '', start_permlink: str = '',
...
async def get_discussions_by_created(context, start_author: str = '', start_permlink: str = '',
                                     limit: int = 20, tag: str = None,
                                     truncate_body: int = 0, filter_tags: list = None):
  return await get_discussions(context, 'created', start_author, start_permlink, limit, tag, truncate_body, filter_tags)
...
async def get_discussions_by_trending(context, start_author: str = '', start_permlink: str = '',
                                      limit: int = 20, tag: str = None,
                                      truncate_body: int = 0, filter_tags: list = None):
  return await get_discussions(context, 'trending', start_author, start_permlink, limit, tag, truncate_body, filter_tags)
...
async def get_discussions_by_hot(context, start_author: str = '', start_permlink: str = '',
                                 limit: int = 20, tag: str = None,
                                 truncate_body: int = 0, filter_tags: list = None):
  return await get_discussions(context, 'hot', start_author, start_permlink, limit, tag, truncate_body, filter_tags)
...
async def get_discussions_by_promoted(context, start_author: str = '', start_permlink: str = '',
                                      limit: int = 20, tag: str = None,
                                      truncate_body: int = 0, filter_tags: list = None):
  return await get_discussions(context, 'promoted', start_author, start_permlink, limit, tag, truncate_body, filter_tags)
...
async def get_post_discussions_by_payout(context, start_author: str = '', start_permlink: str = '',
                                         limit: int = 20, tag: str = None,
                                         truncate_body: int = 0):
  return await get_discussions(context, 'post_by_payout', start_author, start_permlink, limit, tag, truncate_body, [])
...
async def get_comment_discussions_by_payout(context, start_author: str = '', start_permlink: str = '',
                                            limit: int = 20, tag: str = None,
                                            truncate_body: int = 0):
  return await get_discussions(context, 'comment_by_payout', start_author, start_permlink, limit, tag, truncate_body, [])
