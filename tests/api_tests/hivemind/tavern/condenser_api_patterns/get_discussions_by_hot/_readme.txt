Lists not yet paid out posts ranked by hot score (order within the same score is newer first).
Aside from different post format routine is very similar to bridge.get_ranked_posts with hot sort.
