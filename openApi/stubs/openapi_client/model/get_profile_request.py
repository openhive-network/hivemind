...
class GetProfileRequest(ModelNormal):
    ...
    allowed_values = {
        ('method',): {
            'BRIDGE.GET_PROFILE': "bridge.get_profile",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'params': (GetProfileRequestParams,),  # noqa: E501
            'id': (int,),  # noqa: E501
        }
    ...
    def __init__(self, params, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            method (str): defaults to "bridge.get_profile", must be one of ["bridge.get_profile", ]  # noqa: E501
        ...
        method = kwargs.get('method', "bridge.get_profile")
        id = kwargs.get('id', 1)
