...
class GetDiscussionRequestParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, author, permlink, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            observer (str): account name, used to filter out discussion branches starting at posts authored by accounts ignored directly or indirectly by the observer. [optional]  # noqa: E501
        """
